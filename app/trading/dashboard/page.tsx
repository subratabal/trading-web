  ...
  const features = [
    {
      ...
      description: 'Advanced algorithms that reduce trading risk by 73% through real-time market analysis and predictive modeling.',
      color: '#00A3E0',
    },
    {
      icon: Psychology,
      title: 'Autonomous Code Bot',
      description: 'Multi-agent orchestration for automated trading strategy development and deployment.',
      color: '#4CAF50',
    },
    {
      icon: School,
      title: 'Learning Management',
      description: 'Comprehensive training platform for AI trading strategies and compliance requirements.',
      color: '#FF9800',
    },
  ];
          ...
          >
            <motion.div variants={fadeInUp}>
              <Box textAlign="center" mb={6}>
                <Chip
                  label="Trading Dashboard - Institutional Grade AI Trading Platform"
                  sx={{
                ...
                >
                  Reduce Trading Risk by 73% with Advanced AI Algorithms, Multi-Agent Orchestration, and Real-Time Market Intelligence
                </Typography>
